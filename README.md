...
- **Статус** — индикатор состояния gateway в хедере (всегда видим)
- **Control** — управление gateway: Start, Restart, Stop
- **Token Usage** — трафик OpenClaw: агрегированные токены и список ранов (👤 пользовательские запросы, 🤖 внутренние раны) с токенами и стоимостью в $
